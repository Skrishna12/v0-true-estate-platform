  ...
  const reviews = [
    {
      ...
      rating: 5,
      date: "2023-12-15",
      comment: "Great property with an excellent owner. Very responsive and professional.",
    },
    {
      id: "2",
      user: "John Doe",
      rating: 4,
      date: "2023-11-20",
      comment: "Good experience overall. The owner was helpful but sometimes slow to respond.",
    },
    {
      id: "3",
      user: "Alice Johnson",
      rating: 3,
      date: "2023-10-05",
      comment: "Average experience. The property was as described but had some maintenance issues.",
    },
  ]
